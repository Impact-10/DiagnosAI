...
function LoginFormInner() {
  ...
  // Prefer client-side navigation to preserve Next.js state when possible
      ...
      <div className="w-full max-w-md">
        <Card className="bg-slate-900 border-slate-800">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-slate-400">Sign in to your AI Health Assistant</CardDescription>
          </CardHeader>
          <CardContent>
